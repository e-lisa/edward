...
replies = {
    'greeting' : "Bună ziua, eu sunt Edward, robotul GnuPG cel prietenos.",
    'success_decrypt' : "Am primit mesajul dumneavoastră și l-am decriptat.",
    'quote_follows' : "Iată o copie a mesajului dumneavoastră:",
