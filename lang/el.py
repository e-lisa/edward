...
replies = {
    'greeting' : "Γειά σου, είμαι ο Edward, το φιλικό ρομπότ του GnuPG.",
    'success_decrypt' : "Έλαβα το μήνυμα σου και το αποκρυπτογράφησα.",
    'quote_follows' : "Δες ένα αντίγραφο του μηνύματος σου:",
